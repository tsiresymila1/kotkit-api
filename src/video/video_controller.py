...
class VideoController:
    ...
    async def list(self) -> list[Any]:
        ...
        return [(await v.to_pydantic(self.db_service.session, depth=3)).model_dump(mode="json") for v in videos]
    ...
    async def get_by_id(self, video_id: Annotated[str, Param('id')]) -> dict:
        ...
        return await video.to_dict(self.db_service.session, depth=2)
